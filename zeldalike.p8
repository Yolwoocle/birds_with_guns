...
function _draw()
	...
	draw_player()
	print(players[1].y,camx+2,camy+2)
...
function player_update()
	for p in all(players) do
		...
		p.gun:update()
		if fire and p.gun.timer<=0 then
...
function make_gun(name,spr,cd,spd,oa,dmg,is_enemy,fire)
	local gun = {
		name=name,
		spr=spr,
		spd=spd,
...
function update_bullet(b)
	...
	--[[	local dx=e.x+4-b.x
		local dy=e.y+4-b.y
		if not b.is_enemy and touches_rect() then--dx*dx+dy*dy < e.r*e.r then]]--
		local ex2 = e.x+e.bx+e.bw 
		local ey2 = e.y+e.by+e.bh
		if not b.is_enemy and touches_rect(b.x,b.y,
		e.x-4,e.y-4,ex2+4,ey2+4) then
	...
	if is_solid(b.x,b.y) or b.x+11<camx or b.x>camx+128+11 then
		if check_flag(1,b.x,b.y) then
		 mset(b.x\8,b.y\8,39)
		 add(random,{x=(b.x\8)*8+4,y=(b.y\8)*8+4,spr=rnd({55,22,1}),f=rnd({true,false}),r=rnd({true,false})})
...
function gen_train()
	...
	for i=0,5 do
		...
		for j=0,wagonlen-2 do
			...
			if(#nums>0)n=nums[flr(rnd(4))]--#nums
			train[w+j]=n
			del(nums,n)
...
function make_ptc(x,y,r,col,fric)
...
__gfx__

...

...

...
727272727200727200727272727272f2727272727200727272720072727272f2727272727200727200720072727272f2727272727200727200720072727272f2
...
727272727200727200000072727272f2727272727200727272720072727272f2727272727200727200000072727272f2727272727200727200000072727272f2
...
727272727200727200720072727272f2727272727200727272720072727272f2727272727200727200720072727272f2727272727200727272720072727272f2
...

